...
function css_ayllu(){
    ...
    wp_register_style('fuentes', 'https://fonts.googleapis.com/css2?family=Montserrat:wght@600&family=Raleway:wght@400;500;600;700&display=swap', 'all'); 
...
add_action('wp_enqueue_scripts', 'css_ayllu');
