...
<article id="post-<?php the_ID(); ?>" <?php post_class('container-fluid p-0 m-0'); ?>>
	...
	<div class="page">
		<nav class="fs-1 dock col-md-2 col-sm-4">
			<ul class="ms-0">
				<li>
					<a href=""><i class="fa-solid fa-archway me-2"></i></a>
				</li>
				<li>
					<a href=""><i class="fa-sharp fa-solid fa-sun me-2"></i></a>
				</li>
				<li>
					<a href=""><i class="fa-regular fa-star-half-stroke me-2"></i></a>
				</li>
				<li>
					<a href=""><i class="fa-solid fa-puzzle-piece me-2"></i></a>
				</li>
			</ul>
		</nav>
	</div>
