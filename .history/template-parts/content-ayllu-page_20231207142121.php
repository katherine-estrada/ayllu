...
<article id="post-<?php the_ID(); ?>" <?php post_class(); ?> style="background-image: url('<?php echo wp_get_attachment_url(get_post_thumbnail_id ($post->ID));?>'); min-height: 100vh; background-position: center; background-size:cover;">
	<div class="carousel">
		<div class="slider">
