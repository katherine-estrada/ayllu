...
<article id="post-<?php the_ID(); ?>" <?php post_class('container-fluid p-0 m-0'); ?>>
	...
	<div id="info">
		<a href="https://threejs.org/examples/textures/sintel.ogv" target="_blank" rel="noopener">three.js</a> - webgl video demo<br/>
			playing <a href="https://threejs.org/examples/textures/sintel.mp4" target="_blank" rel="noopener">sintel</a> trailer
	</div>
