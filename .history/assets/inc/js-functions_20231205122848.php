...
function ayllu_script()
{
    ...
    wp_register_script('type', 'https://unpkg.com/typed.js@2.1.0/dist/typed.umd.js', true);
...
add_action("wp_enqueue_scripts", "ayllu_script", 1); //1 representa la prioridad, cuanto mayor sea el número, mayor será la prioridad.
