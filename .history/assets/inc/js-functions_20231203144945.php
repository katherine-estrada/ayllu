...
function ayllu_script()
{
    ...
    wp_register_script('effect', 'https://unpkg.com/three@0.159.0/examples/jsm/postprocessing/EffectComposer.js', true);
...
add_action("wp_enqueue_scripts", "ayllu_script", 1); //1 representa prioridad, mas alto el número = mas prioridad.