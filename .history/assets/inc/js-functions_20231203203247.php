...
function enqueue_threejs() {
    wp_register_script('three-js1', 'https://unpkg.com/three@0.159.0/build/three.module.js', array(), null, true);
    wp_register_script('three-js2', 'https://unpkg.com/three@0.159.0/examples/jsm/postprocessing/RenderPass.js', true);
    wp_enqueue_script('three-js1');
    wp_enqueue_script('three-js1');
}
add_action('wp_enqueue_scripts', 'enqueue_threejs',2);
...
add_action('wp_enqueue_scripts', 'include_threejs_addons',1);
//add_action('wp_footer', 'include_threejs_addons',2);
